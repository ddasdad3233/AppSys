            ...
            <div id="login" class="animate form">
                <section class="login_content">
                    <form action="javascript:;" method="post">
                        <h1>Login Form</h1>
                        <div>
                            <input type="text" class="form-control" name="userCode" id="userCode" placeholder="userCode" />
                        </div>
                        <div>
                            <input type="password" class="form-control" name="userPassword" id="userPassword" placeholder="userPassword" />
                        </div>
                        <div>
            ...
            <div id="register" class="animate form">
                <section class="login_content">
                    <form>
                        ...
                        <div>
                            <input type="text" class="form-control" id="userCode" placeholder="Username" required="" />
                        </div>
                        <div>
