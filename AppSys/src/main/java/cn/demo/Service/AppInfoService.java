...
public interface AppInfoService {
	 ...
	 * @return
	 */
	public boolean delectAppInfoByid(@Param(value="id")Integer id);
 ...
 * @return
 */
public boolean deleteAppLogo(@Param(value="id")Integer id);
...
* @throws Exception
*/
public boolean updateVersionId(@Param(value="versionId")Integer versionId,@Param(value="id")Integer appId);
...
* @throws Exception
*/
public boolean updateSaleStatusByAppId(@Param(value="id")Integer appId);
